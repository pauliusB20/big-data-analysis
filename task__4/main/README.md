...
<li>
    ...
    <ul>
        ...
        <li>
        After the collision point was found and ship A and B paths were found, both ship paths were plotted on a visual 2d map. The map is interactive and uses Javascript librararies.                                                        
        </li>
        <li>After all the required search queries related to PARTICLE collision detection </li>
    </ul>
</li>
<li>
    <h3>Results</h3>
    ...
    ```
    <ul>
        <li>Both of the ships have different MMSI and are moving and non stationary based on knot speeds, which is higher than 1 and variation in the coordinates. The interactive map shows how the ships are moving in the sea</li>
        <li>The ships were at a distance about 1.119 meters of each other</li>
        <li>Based on the calculated ship heading angle, HG 165 SOUTH OCEAN ship was heading almost due south, while HG 162 NORTH OCEAN was heading South-West</li>
